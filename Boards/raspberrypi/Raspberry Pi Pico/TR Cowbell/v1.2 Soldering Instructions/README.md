...
5. Solder all 6 I2C address pads. The MCP chips will provide wild results if those pads are left floating, solder them all. Each MCP23017 has hex address 0x20, 1 per I2C bus (a mistake since there are only 2 busses).
