...
# Unfortunately, I used both buses for 2 chips... smh.
# There are no unused I2C buses available for Stemma or I2C on any pin you want. 
# You'll have to use either GP (13,12) or (11,10) to add an I2C device.
# I2C is definitely usable, only in that way.
# Sincerely, DJIdiot
"""
