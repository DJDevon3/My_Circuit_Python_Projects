...
```
I used some random chat messages pasted from discord for the msg examples. It will send/receive long messages reliably now. When no message is received it goes into a timeout mode waiting for a new message, gracefully, without crashing the program.
